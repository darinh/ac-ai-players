...
Generated by running the spike's own `Hash32.Calculate`
implementation against fixed inputs. Each vector is the exact
`u32` returned by the C# code at
[`experiments/headless-client/src/HeadlessAcClient/Crypto/Hash32.cs`](../../../../experiments/headless-client/src/HeadlessAcClient/Crypto/Hash32.cs)
(which is byte-for-byte copied from ACE.Common). Use them to
validate any independent reimplementation.

| Input (hex bytes) | Length | Output |
|---|---|---|
| (empty) | 0 | `0x00000000` |
| `42` | 1 | `0x42010000` |
| `01 02 03` | 3 | `0x01050300` |
| `01 02 03 04` | 4 | `0x04070201` |
| `01 02 03 04 05` | 5 | `0x09080201` |
| `01 02 03 04 05 06 07 08` | 8 | `0x0C120806` |
| `01 02 03 04 05 06 07 08 09` | 9 | `0x15130806` |
| `31 38 30 32` (ASCII `"1802"`) | 4 | `0x32343831` |
| `04 00 00 00 31 38 30 32` (`u32 LE 4` + ASCII `"1802"`) | 8 | `0x32383835` |
| `FF FF FF FF` | 4 | `0x0003FFFF` |
| `FF FF FF FF FF` | 5 | `0xFF04FFFF` |

Calculation walkthrough for `[01 02 03 04 05]` (5 bytes, one
full word plus a 1-byte tail):

- `checksum = 5 << 16 = 0x00050000`
- First 4 bytes as `u32 LE = 0x04030201`
- `checksum = 0x00050000 + 0x04030201 = 0x04080201`
- Tail: 1 byte `0x05`, shift = 3 → add `0x05 << 24 = 0x05000000`
- `checksum = 0x04080201 + 0x05000000 = 0x09080201` ✓

Walkthrough for the all-`0xFF` × 5 case (verifies modular wrap):

- `checksum = 5 << 16 = 0x00050000`
- First 4 bytes as `u32 LE = 0xFFFFFFFF`
- `checksum = 0x00050000 + 0xFFFFFFFF = 0x0004FFFF` (wraps)
- Tail: `0xFF << 24 = 0xFF000000`
- `checksum = 0x0004FFFF + 0xFF000000 = 0xFF04FFFF` ✓
