...
""");
        ...
        if (hasRecentServerDialog && stack is not null)
        {
            ...
            sb.AppendLine(
                "- `## Server hints` and `## Early server directives` contain recent and earliest NPC/server text. If that text ASSIGNS a task " +
