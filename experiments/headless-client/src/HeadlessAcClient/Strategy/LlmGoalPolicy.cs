...
""");
        ...
        if (earlyServerDirectives.Count > 0 || earlyNpcDirectives.Count > 0)
        {
            ...
            sb.AppendLine(
                ...
                "not in `## Visible nearby` yet (and if that directive states a compass " +
