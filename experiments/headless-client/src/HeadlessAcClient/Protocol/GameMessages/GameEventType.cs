...
// GameEventType — verbatim copy of
//   Source/ACE.Server/Network/GameEvent/GameEventType.cs
// in the ACE-bots fork. These are the 0xF7B0 event sub-types.
//
// The values come from the retail server enum and are stable
// (the AC client validates them). Keep this file IN SYNC with
// the source; if a new event type is added server-side it must
// be appended here too or the decoder will print "Unknown".
